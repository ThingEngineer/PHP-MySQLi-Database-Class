...
class MysqliDb
{
     ...
     */
     public function join($joinTable, $joinCondition, $joinType = '')
     {
        ...
        $joinTable = filter_var($joinTable, FILTER_SANITIZE_STRING, FILTER_FLAG_NO_ENCODE_QUOTES);
    ...
    public function orderBy($orderByField, $orderbyDirection = "DESC")
    {
        ...
        $orderByField = filter_var($orderByField, FILTER_SANITIZE_STRING, FILTER_FLAG_NO_ENCODE_QUOTES);
    ...
    {
        $groupByField = filter_var($groupByField, FILTER_SANITIZE_STRING, FILTER_FLAG_NO_ENCODE_QUOTES);
